...
Hi *{}*
Thanks for using me....
I am created by [Coinsto Ever](t.me/coinstocommunityadmin)

No one is gonna help you here 
Get to the main chat 
Thanks
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            buttons = InlineKeyboardMarkup([InlineKeyboardButton(text="Coisnto community", url="http://t.me/coinstocommunity")]])
